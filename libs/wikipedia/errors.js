...
class autocompletionError extends wikiError {
    constructor(message) {
        super(message);
        this.name = 'autocompletionError';
    }
}
exports.autocompletionError = autocompletionError;
